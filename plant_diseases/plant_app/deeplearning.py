...
tf.compat.v1.disable_eager_execution()  # 禁用动态图模式
tf.compat.v1.disable_v2_behavior()      # 强制使用 TF 1.x 行为
...
model = load_model(
    r'D:\DjangoProject\DjangoDesign\Plant-Diseases-Recognition\plant_diseases\plant_app\LightWeight_model.hdf5',
